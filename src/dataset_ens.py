...
def createDataCSV(dataset):
    ...
    retTest = list(set(test_labels).difference(set(train_labels)))
    otherNum = len(retTest)
    classes.extend(retTest)
    ...
    return df, label_map,sparse_y.shape[0], sum_y,train_num/sum_y,n_labels
